...
outlw_MR_openAbout =
{
	...
	((uiNamespace getVariable "outlw_MR_Dialog_About") displayCtrl 1001) ctrlSetText ("Версия: " + outlw_MR_version);
	((uiNamespace getVariable "outlw_MR_Dialog_About") displayCtrl 1003) ctrlSetText ("Сделано: " + outlw_MR_date);
	((uiNamespace getVariable "outlw_MR_Dialog_About") displayCtrl 2400) ctrlSetStructuredText parseText "<t size='0.8'>ОК</t>";
};
